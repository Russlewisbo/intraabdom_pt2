...
![Anatomy of the appendix showing its position relative to the cecum and terminal ileum.](images/appendix.png){#fig-appendix-anatomy width="80%"}
...
![Location of the McBurney point — the point of maximal tenderness in anterior appendicitis.](images/Screenshot%202026-03-04%20133531.png){#fig-mcburney width="60%"}
...
![The Rovsing sign: right lower quadrant pain elicited by palpation of the left lower quadrant.](images/Rovsing.png){#fig-rovsing width="80%"}

::: {#fig-exam-signs layout-ncol="2"}
![Psoas sign — pain with active extension of the right hip](images/psoas.png){#fig-psoas}

![Obturator sign — pain with internal rotation of the right hip](images/obturator.png){#fig-obturator}
...
![Laparoscopic appendectomy — the current standard of care for surgical management of appendicitis.](images/Screenshot%202026-03-04%20183933.png){#fig-laparoscopic width="70%"}
...
![Life cycle of *Entamoeba histolytica* showing transmission via fecal-oral route, excystation, and tissue invasion.](images/Entamoeba_histolytica_life_cycle-en%20(2).svg){#fig-entamoeba-lifecycle width="70%"}
...
![Characteristic "anchovy paste" material aspirated from an amebic liver abscess — the nonpurulent appearance results from *E. histolytica*-induced hepatocyte apoptosis rather than necrosis.](images/Screenshot%202026-03-04%20165702.png){#fig-anchovy-paste width="60%"}
...
![Hypervirulent *Klebsiella pneumoniae* — the mucoid "string test" phenotype characteristic of hypermucoviscous strains associated with community-acquired liver abscess.](images/hypervirulen_Kpneu.png){#fig-kpneumoniae width="60%"}
...
![Geographic distribution of endemic areas for amebic liver abscess — travel history to these regions should prompt consideration of amebic etiology in patients with liver abscess.](images/amebic_liver.png){#fig-endemic-areas width="80%"}
...
![CT imaging of pyogenic liver abscess with percutaneous drainage. CT-guided aspiration is the preferred approach for both diagnostic confirmation and therapeutic drainage.](images/Liver%20abscess.png){#fig-liver-abscess-ct width="70%"}

![CT-guided drainage of liver abscesses. (A) CT revealing multiple hypodense lesions in the right hepatic lobe; (B) follow-up showing catheter in place and decrease in abscess size.](images/fig-77-1-ct-drainage.png){#fig-ct-drainage}
...
![Cholelithiasis — gallstones are the most common cause of biliary obstruction leading to cholecystitis and cholangitis.](images/cholelithiasis-2.png){#fig-cholelithiasis width="60%"}
...
![Acute cholecystitis — inflammation of the gallbladder wall with surrounding inflammatory changes.](images/Screenshot%202026-03-04%20191104.png){#fig-cholecystitis width="70%"}
...
![Ascending cholangitis — infection ascends through the biliary tree when drainage is obstructed.](images/ascending%20cholangitis.png){#fig-cholangitis width="70%"}
...
![ERCP — endoscopic approach for biliary drainage and stone removal](images/ercp.png){#fig-ercp}

![Percutaneous transhepatic drainage — alternative approach when ERCP is not feasible](images/percutaneous.png){#fig-percutaneous}
